...
def make_pipeline():
   ...
   # ===============================================    
    ...
    #Long_universe = value.bottom(2*(NUM_LONG_POSITIONS), mask = (QTradableStocksUS() & market_cap))
    #Short_universe = value.top(2*(NUM_LONG_POSITIONS), mask = (QTradableStocksUS() & market_cap))
    ...
    universe = QTradableStocksUS() & market_cap & sector_screen
